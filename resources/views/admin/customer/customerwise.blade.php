...
Customer  Wise || {{$world->name}}
@endsection
@section('content')
<div class="card shadow">
    <div class="card-header ">
<form action="{{url('/customerwise')}}" method="get"> 
        @csrf 
     <div class="row">
         <div class="col-md-4 ">
                    <div class="row">
                         <div class="col-md-4">
                        <label style="float: center;">Customer:</label>
                        </div>
 ...
 <div class="col-md-4 "> 
  ...
  <div class="table-responsive">
    <table class="table table-bordered  table-sm"> 
      <tr  >
        <th colspan="2" class="text-center"><h5>Sales  Report</h5></th>
      </tr>
      <tr  >
        <th>Name</th>
        <td>{{$users->name}}</td>
...
<div class="row ">
 ...
 <div class="table-responsive">
    <table  class="table table-bordered  table-sm">
     <thead>
         <tr>
             <td colspan="5"class="text-center"><b>Sales Report</b></td>
         </tr>
       <tr>
         <th>SL</th>
         <th>Date</th>
...
<div class="col-md-6">  
    <div class="table-responsive">
      ...
      <tr>
        <td colspan="2"><b>Receivable Balance</b></td>
