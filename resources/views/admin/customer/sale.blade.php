    ...
    <div class="row" style="padding:0px;">
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="row">
                    <a href="{{url('customer_sale/0')}}" class="ml-2"><button class="btn btn-info btn-sm mt-2">All</button></a> 
                    @foreach($category as $cat)                 
                       <a href="{{url('customer_sale/'.$cat->id)}}" class="ml-2"><button class="mt-2">{{$cat->category}}</button></a>            
                    @endforeach
                </div> 
                <hr>
                <div class="card-body">
                 ...
                 <div id="accordion">
                  <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                      <div class="card-body">
                          <div class="ibox-body">
                            <form method="POST" action="{{url('corder')}}">
                                    @csrf
                                <div class="row">
                                  ...
                                  <div class="col-sm-4 form-group">
                                    ...
                                    <div class="col-sm-4 form-group text-center">
                                     <br> 
                                   <button class="btn btn-info" onclick='return confirm("Confirm Sale All Product ??")'  type="submit">Confirm Sale</button>             
                                        </div>
                                        </div>
                                    </form>
                            </div>
        ...
        <div class="card shadow">
          <div class="row" style="padding:0px;">     
              <div class="col-md-12">       
                <div class="table-responsive">
                  <h3 class="text-center">Today Sales</h1>
                  <table class="table">
                  <thead>
