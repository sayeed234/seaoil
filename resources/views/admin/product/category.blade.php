...
<div class="page-content fade-in-up">
    ...
    <form enctype="multipart/form-data" action="{{url('category_store')}}" method="post">
      @csrf
        <div class="modal-body">
            <div class="row">     
                <div class="col-sm-12 form-group">
                    <label>Name</label>
                    <input class="form-control" placeholder="Category Name"  required type="text"  name="category">
                </div> 
            </div>
           </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <form enctype="multipart/form-data" action="{{url('category_update')}}" method="post" >
            @csrf
        <div class="modal-body">
            <div class="row">
                <div class="col-sm-12 form-group">
                    <label>Name</label>
                    <input class="form-control category"   required type="text"  name="category">
    ...
    <div class="card shadow">
        ...
        <div class="row">
            <div class="col-md-6"><h5 class="m-0 font-weight-bold ">Product Category List</h5></div>   
            <div class="col-md-6">
           ...
           <table id="example" class="table table-bordered table-hover table-sm">
              ...
              <td> <div class="dropdown show">
                    ...
                    <a class="dropdown-item" href="" onclick= 'edit({{$blog->id}});' data-toggle="modal" id="edit" 
                       ...
                       <a  class="dropdown-item"  href="{{url('category_delete/'.$blog->id)}}" onclick='return confirm("Confirm Delete ??")' >Delete</a>
                    </div>
                    </div>
                </td>
               </tr>
