...
Order #{{$order->invoice}} || {{$world->name}}
@endsection
@section('content')
...
<div class="col-md-4">
  <br> <br> <br><br> <br>
    ...
    <div class="col-sm-12 "> 
      ...
      <div class="col-sm-4">Billing Date: {{ date('d-M-Y', strtotime($order->created_at)) }} </div>
    ...
    <div class="col-sm-12 ">
        <div class="table-responsive">
            <table class="table table-bordered  table-sm">
               <thead>
                <tr >
                       <td colspan="5" class="text-center"><b>Sales Details</b></td>
                   </tr>
                 <tr>
                   <th>Sl</th>
                   <th>Name</th>
               ...
               @endforeach
               <tr>
                   <td colspan="4" class="text-right"><b>Total Sales</b></td>
                   <td  ><b>{{$sum}} Tk.</b></td>
               </tr>
               <tr>
                <td colspan="4" class="text-right"><b>Total Receive</b></td>
                <td >@if($payment)<b>{{$payment->payment}} Tk. @else  <b>0000 Tk.</b> @endif</b></td>
              </tr>
              <tr>
                <td colspan="4" class="text-right"><b>Receivable Amount</b></td>
